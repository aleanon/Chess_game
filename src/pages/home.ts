...
export class HomePage implements Page {
    ...
    private initializeElements(): void {
        ...
        this.container = document.getElementById(this.CONTAINER_ID) as HTMLElement;
        this.computerButton = document.getElementById(this.COMPUTER_BTN_ID) as HTMLButtonElement;
        this.friendButton = document.getElementById(this.FRIEND_BTN_ID) as HTMLButtonElement;
        this.practiceButton = document.getElementById(this.PRACTICE_BTN_ID) as HTMLButtonElement;
    }

    private setupEventListeners(): void {
        // Now we can use our stored references directly
        this.computerButton.addEventListener('click', () => this.startComputerGame());
        this.friendButton.addEventListener('click', () => this.startFriendGame());
        this.practiceButton.addEventListener('click', () => this.startPracticeMode());
    }
    ...
    private startPracticeMode(): void {
        ...
        // Practice mode initialization logic here
    }
